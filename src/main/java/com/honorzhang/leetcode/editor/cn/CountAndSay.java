...
// 👍 702 👎 0
  ...
  public class CountAndSay{
      public static void main(String[] args) {
           Solution1 solution1 = new CountAndSay().new Solution1();
          Solution2 solution2 = new CountAndSay().new Solution2();
          System.out.println("solution1: " + solution1.countAndSay(10));
          System.out.println("solution2: " + solution2.countAndSay(10));
      }
                ...
                while(index < n){
                    ...
                    for (; i < original.length() - 1; i++) {
                        if (original.substring(i, i+1).equals(original.substring(i+1, i+2))){
                            ...
                            sb.append(j).append(original.charAt(i));
                            j = 1;
                        }
                    }
